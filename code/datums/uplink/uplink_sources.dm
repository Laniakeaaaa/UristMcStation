...
/decl/uplink_source/pda/setup_uplink_source(var/mob/M, var/amount)
	...
	to_chat(M, "<span class='notice'>A portable object teleportation relay has been installed in your [P.name]. Simply enter the code \"[pda_pass]\" in your TaxQuickly program to unlock its hidden features.</span>")
...
/decl/uplink_source/implant
	name = "Implant"
	desc = "Teleports an uplink implant into your head. Costs 20% the initial TC amount."
...
/decl/uplink_source/telecrystals
	name = "Telecrystals"
	desc = "Get your telecrystals in pure form, without the means to trade them for goods, Gives 150% of the initial TC amount"
